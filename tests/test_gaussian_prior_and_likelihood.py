...
def test():
    ...
    To check the first equality, we multiply C_P^{-1} + C_L^{-1} by C, and compute the distance to the identity,
        absolute tolerance of 10 % * sqrt(dim).
    Component-wise relative tolerance up to 10% for the second inequality.
    Increase the number of particles and MCMC steps to get better approximations, and increase the tolerances to account for the dimension.
    """
    ...
    atol_accounted_for_the_dimension = 10 * 1e-2
