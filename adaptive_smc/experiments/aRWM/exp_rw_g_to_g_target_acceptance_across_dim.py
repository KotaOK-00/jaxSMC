...
from adaptive_smc.experiments.aRWM.problem import construct_my_prior_and_target
...
def experiment_rwmh(config, keys, dim):
    ...
    config['latent_dim'] = int(dim * config['problem']['latent_dim_coeff'])
...
if __name__ == "__main__":
    yaml_file = "exp_rw_g_to_g_target_acceptance_across_dim.yaml"
